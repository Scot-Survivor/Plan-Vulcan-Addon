...
public class VulcanStorage {
    ...
    public int getViolations(UUID uuid, String violation_string) {
        ...
        return queryService.query(sql, statement -> {
            ...
            try (ResultSet resultSet = statement.executeQuery()) {
                resultSet.next();
                return resultSet.getInt(violation_string);
            } catch (SQLException e) {
                getLogger().severe("Failed to get violations: " + e.getMessage());
                return -1;
            }
        });
    }
